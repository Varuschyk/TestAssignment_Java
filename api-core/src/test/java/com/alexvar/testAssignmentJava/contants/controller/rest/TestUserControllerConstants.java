package com.alexvar.testAssignmentJava.contants.controller.rest;
...
@UtilityClass
public class TestUserControllerConstants {
  ...
  public final String USER_BIRTH_DAY_2000 = "1-11-2000";
  ...
  public final List<UserDto> USER_DTO_LIST = List.of(USER_DTO);
}
